...
public class Voronoi {
    ...
    /**
     * Generate Voronoi using the graph of triangle computed by {@link #generateTriangleNeighbors(Geometry)}
     *
    ...
    private static class EnvelopeWithIndex {
        ...
        EnvelopeWithIndex(int index, Coordinate position) {
            this.index = index;
            this.position = position;
        }

        void addSharingTriangle(int triangleId) {
            sharingTriangles.add(triangleId);
        }

        Set<Integer> getSharingTriangles() {
    ...
    private static class QuadTreeVisitor implements ItemVisitor {
        ...
        QuadTreeVisitor(double maxDist, Coordinate goal) {
            this.maxDist = maxDist;
            this.goal = goal;
        }

        EnvelopeWithIndex getNearest() {
            return nearest;
        }
