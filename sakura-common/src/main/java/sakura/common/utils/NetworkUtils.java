...
public class NetworkUtils {
    ...
    public static boolean isIpv4(String value) {
        return RegexUtils.isMatch(RegexUtils.IPV4, value);
    }
    ...
    public static boolean isInnerIP(String ipAddress) {
        ...
        long aBegin = NetworkUtils.ipv4ToLong("10.0.0.0");
        long aEnd = NetworkUtils.ipv4ToLong("10.255.255.255");

        long bBegin = NetworkUtils.ipv4ToLong("172.16.0.0");
        long bEnd = NetworkUtils.ipv4ToLong("172.31.255.255");

        long cBegin = NetworkUtils.ipv4ToLong("192.168.0.0");
        long cEnd = NetworkUtils.ipv4ToLong("192.168.255.255");
