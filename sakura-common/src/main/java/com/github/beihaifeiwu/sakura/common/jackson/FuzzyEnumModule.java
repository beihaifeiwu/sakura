package com.github.beihaifeiwu.sakura.common.jackson;
...
import com.github.beihaifeiwu.sakura.common.utils.EnumUtils;
...
public class FuzzyEnumModule extends Module {
    ...
    private static class PermissiveEnumDeserializer extends StdScalarDeserializer<Enum<?>> {
        ...
        public Enum<?> deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException {
            ...
            throw JsonMappingException.from(jp, jp.getText() + " was not one of " + acceptedValues);
        }
    }
        ...
        public JsonDeserializer<?> findEnumDeserializer(Class<?> type,
            ...
            for (Field field : type.getFields()) {
                for (Annotation annotation : field.getAnnotations()) {
                    ...
                    if ("com.fasterxml.jackson.annotation".equals(packageName)) {
                        return null;
                    }
                }
            }
