...
public abstract class AbstractAnnotationProcessor implements BeanPostProcessor {
    ...
    public AbstractAnnotationProcessor(final Members members, final Phase phase, final AnnotationFilter filter) {
